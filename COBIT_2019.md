...
## Priporočene nastavitve repozitorija

- **Branch protection** na `main`: required reviews (2), required status checks, no force push.  
- **CODEOWNERS**: določeni pregledi po področjih (BE/FE/SEC/DPO).  
- **Actions CI/CD**: build, testi, varnostni skeni; CD z **Environments** in odobravanjem.  
- **Templates**: `.github/ISSUE_TEMPLATE.md`, `.github/PULL_REQUEST_TEMPLATE.md` (checklista BAI06/GDPR).  
- **Labels/Milestones/Projects**: skladno z našim kanbanom (6 faz) in mejniki M1–M4.

## Opombe za demonstracijo na vajah

1. Odpri issue, poveži z milestone in project kolono.  
2. Ustvari PR, ki **avtomatsko zapre** issue (`Fixes #123`).  
3. Prikaži **required checks** in **approval gate** pred merge.  
4. Ob merge → release note + premik kartice v **Done**.  
5. Pokaži **Insights** (lead time) in **Actions** (uspešnost sprememb).
